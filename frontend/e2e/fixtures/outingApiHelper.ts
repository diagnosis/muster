...
const outings: Omit<CreateOutingInput, 'starts_at'>[] = [
    ...
    { title: 'Rattlesnake Ledge', destination: 'North Bend', meet_label: 'Eastgate P&R', max_size: 8, host_seats: 4, cost_per_seat_cents: 250, difficulty: 'easy', pace: 'relaxed', notes: 'Busy trail — early start' },
    ...
    { title: 'Snow Lake', destination: 'Snoqualmie Pass', meet_label: 'Issaquah TC', max_size: 8, host_seats: 3, cost_per_seat_cents: 450, difficulty: 'moderate', pace: 'moderate', notes: 'Alpine lake, lingering snow in early season' },
    ...
    { title: 'Lake 22', destination: 'Mountain Loop Highway', meet_label: 'Everett Station', max_size: 6, host_seats: 3, cost_per_seat_cents: 550, difficulty: 'moderate', pace: 'moderate', notes: 'Old-growth cedar and a cirque lake' },
